...
function toggleDarkMode() {
    ...
    document.documentElement.style.setProperty('--color-whit', isDarkMode ? '#111111' : '#fff');
    document.documentElement.style.setProperty('--color-blac', isDarkMode ? '#fff' : '#111111');
